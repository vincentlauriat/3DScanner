...
| UI | `RoomScanner/UI` | SwiftUI screens: list, detail (Plan 2D / 3D / Measures), export sheet, error screens, settings | App, Domain, Export, Storage, QuickLook |
...
- Storage v2 adds `Documents/Houses/<uuid>/house.json` (room ids + transforms + merged structure); room folders stay untouched.
